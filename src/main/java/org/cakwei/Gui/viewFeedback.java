...
public class viewFeedback extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentTextArea.setEnabled(false);
        jScrollPane1.setViewportView(studentTextArea);

        studentLabel.setText("Student feedback:");

        lecturerLabel.setText("Lecturer feedback:");

        lecturerTextArea.setColumns(20);
        lecturerTextArea.setRows(5);
        lecturerTextArea.setEnabled(false);
    ...
    public javax.swing.JTextArea lecturerTextArea;
    private javax.swing.JLabel studentLabel;
    public javax.swing.JTextArea studentTextArea;
